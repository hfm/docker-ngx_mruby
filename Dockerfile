...
RUN git clone --depth=1 --branch=$NGX_MRUBY_VERSION https://github.com/matsumoto-r/ngx_mruby.git /usr/local/src/ngx_mruby && cd /usr/local/src/ngx_mruby && sh build.sh && make install && rm -rf /usr/local/src/ngx_mruby
